...
namespace LEM_Editor
{
    ...
    public class CurveAnchPosYNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveAnchPosY";
        ...
        {
            CurveAnchPosY myEffect = go.AddComponent<CurveAnchPosY>();
        ...
        {
            CurveAnchPosY loadFrom = effectToLoadFrom as CurveAnchPosY;
