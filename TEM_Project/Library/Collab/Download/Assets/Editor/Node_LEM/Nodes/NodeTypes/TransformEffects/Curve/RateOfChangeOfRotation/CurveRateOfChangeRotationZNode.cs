...
namespace LEM_Editor
{
    ...
    public class CurveRateOfChangeRotationZNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        Space m_RelativeSpace = default;
        protected override string EffectTypeName => "CurveRateOfChangeRotationZ";
        ...
        {
            CurveRateOfChangeRotationZ myEffect =go.AddComponent<CurveRateOfChangeRotationZ>();
            //CurveRateOfChangeRotationZ myEffect = ScriptableObject.CreateInstance<CurveRateOfChangeRotationZ>();
        ...
        {
            CurveRateOfChangeRotationZ loadFrom = effectToLoadFrom as CurveRateOfChangeRotationZ;
