...
namespace LEM_Editor
{
    ...
    public class CurvePosZNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurvePosZ";
        ...
        {
            CurvePosZ myEffect = go.AddComponent<CurvePosZ>();
            //CurvePosZ myEffect = ScriptableObject.CreateInstance<CurvePosZ>();
        ...
        {
            CurvePosZ loadFrom = effectToLoadFrom as CurvePosZ;
