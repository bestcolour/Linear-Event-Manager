...
namespace LEM_Editor
{
    ...
    public class CurveRotationXNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveRotationX";
        ...
        public override void Draw()
        {
            ...
            propertyRect.y += 20f;
            m_Graph = EditorGUI.CurveField(propertyRect, "X Rotation", m_Graph);
            propertyRect.y += 20f;
        ...
        {
            CurveRotationX myEffect = go.AddComponent<CurveRotationX>();
            //CurveRotationX myEffect = ScriptableObject.CreateInstance<CurveRotationX>();
        ...
        {
            CurveRotationX loadFrom = effectToLoadFrom as CurveRotationX;
