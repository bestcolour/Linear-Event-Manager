...
namespace LEM_Editor
{
    ...
    public class CurveAlphaToGraphicsNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "CurveAlphaToGraphics";
        ...
        {
            CurveAlphaToGraphics myEffect = go.AddComponent<CurveAlphaToGraphics>();
        ...
        {
            CurveAlphaToGraphics loadFrom = effectToLoadFrom as CurveAlphaToGraphics;
            loadFrom.UnPack(out Graphic[] t1,out m_Graph );
