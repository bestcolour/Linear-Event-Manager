...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaRenderersNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "FadeToAlphaRenderers";
        ...
        {
            FadeToAlphaRenderers myEffect =go.AddComponent<FadeToAlphaRenderers>();
            //FadeToAlphaRenderers myEffect = ScriptableObject.CreateInstance<FadeToAlphaRenderers>();
        ...
        {
            FadeToAlphaRenderers loadFrom = effectToLoadFrom as FadeToAlphaRenderers;
            loadFrom.UnPack(out Renderer[] t1,out m_TargetAlpha,out m_Duration);
