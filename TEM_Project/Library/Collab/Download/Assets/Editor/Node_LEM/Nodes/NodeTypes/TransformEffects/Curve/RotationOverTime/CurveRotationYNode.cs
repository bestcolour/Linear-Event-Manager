...
namespace LEM_Editor
{
    ...
    public class CurveRotationYNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveRotationY";
        ...
        public override void Draw()
        {
            ...
            propertyRect.y += 20f;
            m_Graph = EditorGUI.CurveField(propertyRect, "Y Rotation", m_Graph);
            propertyRect.y += 20f;
        ...
        {
            CurveRotationY myEffect = go.AddComponent<CurveRotationY>();
            //CurveRotationY myEffect = ScriptableObject.CreateInstance<CurveRotationY>();
        ...
        {
            CurveRotationY loadFrom = effectToLoadFrom as CurveRotationY;
