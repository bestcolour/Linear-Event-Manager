...
namespace LEM_Editor
{
    ...
    public class CurveAlphaToTextMeshesNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "CurveAlphaToTextMeshes";
        ...
        {
            CurveAlphaToTextMeshes myEffect = go.AddComponent<CurveAlphaToTextMeshes>();
        ...
        {
            CurveAlphaToTextMeshes loadFrom = effectToLoadFrom as CurveAlphaToTextMeshes;
            loadFrom.UnPack(out TextMesh[] t1, out m_Graph);
