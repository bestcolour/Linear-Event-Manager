...
namespace LEM_Editor
{
    ...
    public class LerpScaleToV3Node : UpdateEffectNode
    {
        [SerializeField]
        ...
        protected override string EffectTypeName => "LerpScaleToV3";
        ...
        {
            LerpScaleToV3 myEffect = go.AddComponent<LerpScaleToV3>();
            //LerpScaleToV3 myEffect = ScriptableObject.CreateInstance<LerpScaleToV3>();
        ...
        {
            LerpScaleToV3 loadFrom = effectToLoadFrom as LerpScaleToV3;
