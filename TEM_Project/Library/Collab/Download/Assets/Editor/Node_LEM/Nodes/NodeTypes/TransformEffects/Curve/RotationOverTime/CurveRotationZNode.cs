...
namespace LEM_Editor
{
    ...
    public class CurveRotationZNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveRotationZ";
        ...
        public override void Draw()
        {
            ...
            propertyRect.y += 20f;
            m_Graph = EditorGUI.CurveField(propertyRect, "Z Rotation", m_Graph);
            propertyRect.y += 20f;
        ...
        {
            CurveRotationZ myEffect = go.AddComponent<CurveRotationZ>();
            //CurveRotationZ myEffect = ScriptableObject.CreateInstance<CurveRotationZ>();
        ...
        {
            CurveRotationZ loadFrom = effectToLoadFrom as CurveRotationZ;
