...
namespace LEM_Editor
{
    ...
    public class MoveScaleToTAboutTPivotNode : UpdateEffectNode
    {
        [SerializeField]
        ...
        protected override string EffectTypeName => "MoveScaleToTAboutTPivot";
        ...
        {
            MoveScaleToTAboutTPivot myEffect = go.AddComponent<MoveScaleToTAboutTPivot>();
            //MoveScaleToTAboutTPivot myEffect = ScriptableObject.CreateInstance<MoveScaleToTAboutTPivot>();
        ...
        {
            MoveScaleToTAboutTPivot loadFrom = effectToLoadFrom as MoveScaleToTAboutTPivot;
