...
namespace LEM_Editor
{
    ...
    public class LerpRotationToTAboutV3PivotNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "LerpRotationToTAboutV3Pivot";
        ...
        {
            LerpRotationToTAboutV3Pivot myEffect = go.AddComponent<LerpRotationToTAboutV3Pivot>();
            //LerpRotationToTAboutV3Pivot myEffect = ScriptableObject.CreateInstance<LerpRotationToTAboutV3Pivot>();
            ...
            myEffect.SetUp(m_TargetTransform, m_ReferenceTransformRotation, m_PivotWorldPosition, m_WorldRotation, m_Smoothing, m_SnapRange);
            return myEffect;
        ...
        {
            LerpRotationToTAboutV3Pivot loadFrom = effectToLoadFrom as LerpRotationToTAboutV3Pivot;
            loadFrom.UnPack(out m_TargetTransform, out m_ReferenceTransformRotation, out m_PivotWorldPosition, out m_WorldRotation, out m_Smoothing, out m_SnapRange);
