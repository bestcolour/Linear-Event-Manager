...
namespace LEM_Editor
{
    ...
    public class CurveRateOfChangeAnchPosYNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveRateOfChangeAnchPosY";
        ...
        {
            CurveRateOfChangeAnchPosY myEffect = go.AddComponent<CurveRateOfChangeAnchPosY>();
            //CurveRateOfChangeAnchPosY myEffect = ScriptableObject.CreateInstance<CurveRateOfChangeAnchPosY>();
        ...
        {
            CurveRateOfChangeAnchPosY loadFrom = effectToLoadFrom as CurveRateOfChangeAnchPosY;
