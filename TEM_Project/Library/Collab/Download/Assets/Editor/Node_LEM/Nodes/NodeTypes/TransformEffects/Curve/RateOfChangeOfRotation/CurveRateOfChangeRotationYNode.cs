...
namespace LEM_Editor
{
    ...
    public class CurveRateOfChangeRotationYNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        Space m_RelativeSpace = default;
        protected override string EffectTypeName => "CurveRateOfChangeRotationY";
        ...
        {
            CurveRateOfChangeRotationY myEffect = go.AddComponent<CurveRateOfChangeRotationY>();
            //CurveRateOfChangeRotationY myEffect = ScriptableObject.CreateInstance<CurveRateOfChangeRotationY>();
        ...
        {
            CurveRateOfChangeRotationY loadFrom = effectToLoadFrom as CurveRateOfChangeRotationY;
