...
{
    [AddComponentMenu("")] public class  RepeatLerpRotationToV3AboutV3Pivot : UpdateBaseEffect
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            RepeatLerpRotationToV3AboutV3Pivot t = go.AddComponent<RepeatLerpRotationToV3AboutV3Pivot>();
