...
{
    [AddComponentMenu("")] public class  CurveRateOfChangePosY : SingleCurveBasedUpdateEffect<CurveRateOfChangePosY>
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            CurveRateOfChangePosY t = go.AddComponent<CurveRateOfChangePosY>();
