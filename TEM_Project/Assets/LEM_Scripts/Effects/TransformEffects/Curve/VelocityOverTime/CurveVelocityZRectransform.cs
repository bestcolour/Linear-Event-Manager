...
{
    public class CurveVelocityZRectransform : TimerBasedUpdateEffect
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            CurveVelocityZRectransform copy = ScriptableObject.CreateInstance<CurveVelocityZRectransform>();
        ...
        public override bool OnUpdateEffect(float delta)
        {
            ...
            m_FramePosition.z += m_Graph.Evaluate(m_Timer) * delta;
