...
{
    public class CurveVelocityYRectransform : TimerBasedUpdateEffect
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            CurveVelocityYRectransform copy = ScriptableObject.CreateInstance<CurveVelocityYRectransform>();
        ...
        public override bool OnUpdateEffect(float delta)
        {
            ...
            m_FramePosition.y += m_Graph.Evaluate(m_Timer) *delta;
