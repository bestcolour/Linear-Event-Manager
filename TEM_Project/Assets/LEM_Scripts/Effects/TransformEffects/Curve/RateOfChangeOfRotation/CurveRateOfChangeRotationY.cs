...
{
    [AddComponentMenu("")] public class  CurveRateOfChangeRotationY : SingleCurveBasedUpdateEffect<CurveRateOfChangeRotationY>
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            CurveRateOfChangeRotationY t = go.AddComponent<CurveRateOfChangeRotationY>();
        ...
        //{
        //    CurveRateOfChangeRotationY copy = ScriptableObject.CreateInstance<CurveRateOfChangeRotationY>();
        ...
        public override bool OnUpdateEffect(float delta)
        {
            ...
            m_TargetTransform.Rotate(0f, m_Graph.Evaluate(m_Timer) * delta, 0f, m_RelativeSpace);
