...
namespace LEM_Effects
{
    ...
    public class CurveZRectransformToPosition : TimerBasedUpdateEffect, IEffectSavable<RectTransform, AnimationCurve>
    {
        ...
        public override bool OnUpdateEffect(float delta)
        {
            ...
            m_FramePosition.z += m_VelocityGraph.Evaluate(m_Timer);
