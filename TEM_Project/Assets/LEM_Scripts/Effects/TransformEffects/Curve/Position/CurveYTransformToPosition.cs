...
namespace LEM_Effects
{
    ...
    public class CurveYTransformToPosition : TimerBasedUpdateEffect, IEffectSavable<Transform, AnimationCurve, bool>
    {
        ...
        public override bool OnUpdateEffect(float delta)
        {
            ...
            m_FramePosition += m_YDirection * m_VelocityGraph.Evaluate(m_Timer);
