...
namespace LEM_Editor
{
    ...
    public class PlayBiasedLinearEventNode : InstantEffectNode
    {
        ...
        protected override string EffectTypeName => "PlayBiasedLinearEvent";
        ...
        {
            PlayBiasedLinearEvent myEffect = go.AddComponent<PlayBiasedLinearEvent>();
        ...
        {
            PlayBiasedLinearEvent loadFrom = effectToLoadFrom as PlayBiasedLinearEvent;
