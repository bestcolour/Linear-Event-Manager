...
namespace LEM_Editor
{
    ...
    public class LoadRandomLinearEventNode : InstantEffectNode
    {
        ArrayObjectDrawer<LinearEvent> m_ArrayOfGameObjects = new ArrayObjectDrawer<LinearEvent>();

        protected override string EffectTypeName => "LoadRandomLinearEvent";
        ...
        {
            LoadRandomLinearEvent loadFrom = effectToLoadFrom as LoadRandomLinearEvent;
