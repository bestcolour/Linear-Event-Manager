...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextMeshProsNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "FadeToAlphaTextMeshPros";
        ...
        {
            FadeToAlphaTextMeshPros myEffect = ScriptableObject.CreateInstance<FadeToAlphaTextMeshPros>();
        ...
        {
            FadeToAlphaTextMeshPros loadFrom = effectToLoadFrom as FadeToAlphaTextMeshPros;
            loadFrom.UnPack(out TextMeshPro[] t1,out m_TargetAlpha,out m_Duration);
