...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaRenderersComponentNode : UpdateEffectNode
    {
        ...
        {
            FadeToAlphaRenderersComponent myEffect = ScriptableObject.CreateInstance<FadeToAlphaRenderersComponent>();
        ...
        {
            FadeToAlphaRenderersComponent loadFrom = effectToLoadFrom as FadeToAlphaRenderersComponent;
