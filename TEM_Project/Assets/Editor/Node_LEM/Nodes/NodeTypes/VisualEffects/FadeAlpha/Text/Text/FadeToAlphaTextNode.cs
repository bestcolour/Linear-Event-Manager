...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextNode : UpdateEffectNode
    {
        ...
        {
            FadeToAlphaText myEffect = ScriptableObject.CreateInstance<FadeToAlphaText>();
        ...
        {
            FadeToAlphaText loadFrom = effectToLoadFrom as FadeToAlphaText;
