...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextMeshProComponentNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "FadeToAlphaTextMeshPro";
        ...
        {
            FadeToAlphaTextMeshProComponent myEffect = ScriptableObject.CreateInstance<FadeToAlphaTextMeshProComponent>();
        ...
        {
            FadeToAlphaTextMeshProComponent loadFrom = effectToLoadFrom as FadeToAlphaTextMeshProComponent;
