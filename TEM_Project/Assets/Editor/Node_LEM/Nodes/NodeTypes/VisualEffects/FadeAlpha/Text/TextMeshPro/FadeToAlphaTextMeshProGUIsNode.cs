...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextMeshProGUIsNode : UpdateEffectNode
    {

        ArrayObjectDrawer<TextMeshProUGUI> m_ArrayOfGameObjects = new ArrayObjectDrawer<TextMeshProUGUI>();
        float m_TargetAlpha =0f,m_Duration =0f;
        

        protected override string EffectTypeName => "FadeToAlphaTextMeshProGUIs";
        ...
        {
            FadeToAlphaTextMeshProGUIs myEffect = ScriptableObject.CreateInstance<FadeToAlphaTextMeshProGUIs>();
        ...
        {
            FadeToAlphaTextMeshProGUIs loadFrom = effectToLoadFrom as FadeToAlphaTextMeshProGUIs;
            loadFrom.UnPack(out TextMeshProUGUI[] t1,out m_TargetAlpha,out m_Duration);
