...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextMeshProsComponentNode : UpdateEffectNode
    {
        ...
        {
            FadeToAlphaTextMeshProsComponent myEffect = ScriptableObject.CreateInstance<FadeToAlphaTextMeshProsComponent>();
        ...
        {
            FadeToAlphaTextMeshProsComponent loadFrom = effectToLoadFrom as FadeToAlphaTextMeshProsComponent;
