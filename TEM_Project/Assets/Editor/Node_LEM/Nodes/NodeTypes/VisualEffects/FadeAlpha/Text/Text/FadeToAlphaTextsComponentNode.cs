...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextsComponentNode : UpdateEffectNode
    {

        ArrayObjectDrawer<Text> m_ArrayOfGameObjects = new ArrayObjectDrawer<Text>();
        float m_TargetAlpha =0f,m_Duration =0f;
        

        protected override string EffectTypeName => "FadeToAlphaTexts";
        ...
        {
            FadeToAlphaTextsComponent myEffect = ScriptableObject.CreateInstance<FadeToAlphaTextsComponent>();
        ...
        {
            FadeToAlphaTextsComponent loadFrom = effectToLoadFrom as FadeToAlphaTextsComponent;
            loadFrom.UnPack(out Text[] t1,out m_TargetAlpha,out m_Duration);
