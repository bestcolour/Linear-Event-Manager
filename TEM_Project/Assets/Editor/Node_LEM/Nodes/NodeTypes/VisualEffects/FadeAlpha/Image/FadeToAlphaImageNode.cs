...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaImageNode : UpdateEffectNode
    {
        ...
        {
            FadeToAlphaImage myEffect = ScriptableObject.CreateInstance<FadeToAlphaImage>();
        ...
        {
            FadeToAlphaImage loadFrom = effectToLoadFrom as FadeToAlphaImage;
