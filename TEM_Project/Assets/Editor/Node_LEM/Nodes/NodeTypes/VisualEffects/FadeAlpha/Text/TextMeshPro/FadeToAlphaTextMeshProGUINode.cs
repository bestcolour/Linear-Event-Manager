...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextMeshProGUINode : UpdateEffectNode
    {
        ...
        {
            FadeToAlphaTextMeshProGUI myEffect = ScriptableObject.CreateInstance<FadeToAlphaTextMeshProGUI>();
        ...
        {
            FadeToAlphaTextMeshProGUI loadFrom = effectToLoadFrom as FadeToAlphaTextMeshProGUI;
