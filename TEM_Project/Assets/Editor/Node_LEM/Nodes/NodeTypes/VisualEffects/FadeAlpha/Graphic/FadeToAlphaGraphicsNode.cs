...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaGraphicsNode : UpdateEffectNode
    {

        ArrayObjectDrawer<Graphic> m_ArrayOfGameObjects = new ArrayObjectDrawer<Graphic>();
        float m_TargetAlpha = 0f, m_Duration = 0f;



        protected override string EffectTypeName => "FadeToAlphaGraphics";
        ...
        {
            FadeToAlphaGraphics myEffect = go.AddComponent<FadeToAlphaGraphics>();
        ...
        {
            FadeToAlphaGraphics loadFrom = effectToLoadFrom as FadeToAlphaGraphics;
            loadFrom.UnPack(out Graphic[] t1, out m_TargetAlpha, out m_Duration);
