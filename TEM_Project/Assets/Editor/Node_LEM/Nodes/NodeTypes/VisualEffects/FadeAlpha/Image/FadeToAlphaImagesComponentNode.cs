...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaImagesComponentNode : UpdateEffectNode
    {
        ...
        {
            FadeToAlphaImagesComponent myEffect = ScriptableObject.CreateInstance<FadeToAlphaImagesComponent>();
        ...
        {
            FadeToAlphaImagesComponent loadFrom = effectToLoadFrom as FadeToAlphaImagesComponent;
