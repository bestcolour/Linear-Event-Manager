...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextMeshProGUIsComponentNode : UpdateEffectNode
    {
        ...
        {
            FadeToAlphaTextMeshProGUIsComponent loadFrom = effectToLoadFrom as FadeToAlphaTextMeshProGUIsComponent;
