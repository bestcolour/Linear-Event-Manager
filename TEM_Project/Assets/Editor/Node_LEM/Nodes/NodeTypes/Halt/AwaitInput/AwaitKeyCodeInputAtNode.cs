...
namespace LEM_Editor
{
    ...
    public class AwaitKeyCodeInputAtNode : UpdateEffectNode
    {
        //Array properties
        ...
        protected override string EffectTypeName => "AwaitKeyCodeInputAt";
        ...
        public override void Draw()
        {
            ...
            if (m_PreviousArrayTotalSize != m_CurrentArrayTotalSize)
            {
                ...
                SetMidRectSize(NodeTextureDimensions.LARGE_MID_SIZE + Vector2.up * 20f * m_PreviousArrayTotalSize);
            }
