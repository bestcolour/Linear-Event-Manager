...
namespace LEM_Editor
{
    ...
    public class CurveAnchPosXNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveAnchPosX";
        ...
        {
            CurveAnchPosX loadFrom = effectToLoadFrom as CurveAnchPosX;
