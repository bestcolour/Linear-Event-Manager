...
namespace LEM_Editor
{
    ...
    public class CurveDisplaceXTransformToPositionNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveDisplaceXTransformToPosition";
        ...
        {
            CurveDisplaceXTransformToPosition myEffect = ScriptableObject.CreateInstance<CurveDisplaceXTransformToPosition>();
        ...
        {
            CurveDisplaceXTransformToPosition loadFrom = effectToLoadFrom as CurveDisplaceXTransformToPosition;
