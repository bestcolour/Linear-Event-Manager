...
namespace LEM_Editor
{
    ...
    public class CurveRateOfChangeRotationYNode : UpdateEffectNode
    {
        ...
        {
            LEM_Effects.CurveRateOfChangeRotationY myEffect = ScriptableObject.CreateInstance<LEM_Effects.CurveRateOfChangeRotationY>();
        ...
        {
            LEM_Effects.CurveRateOfChangeRotationY loadFrom = effectToLoadFrom as LEM_Effects.CurveRateOfChangeRotationY;
