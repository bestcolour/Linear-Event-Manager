...
namespace LEM_Editor
{
    ...
    public class CurveXTransformToPositionNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_VelocityGraph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveXTransformToPosition";
        ...
        public override void Draw()
        {
            ...
            propertyRect.y += 20f;
            m_VelocityGraph = EditorGUI.CurveField(propertyRect, "X Velocity", m_VelocityGraph);
            propertyRect.y += 20f;
        ...
        {
            CurveXTransformToPosition myEffect = ScriptableObject.CreateInstance<CurveXTransformToPosition>();
        ...
        {
            CurveXTransformToPosition loadFrom = effectToLoadFrom as CurveXTransformToPosition;
