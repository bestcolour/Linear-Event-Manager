...
namespace LEM_Editor
{
    ...
    public class CurveVelocityZRectransformNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveVelocityZRectransform";
        ...
        {
            CurveVelocityZRectransform myEffect = ScriptableObject.CreateInstance<CurveVelocityZRectransform>();
        ...
        {
            CurveVelocityZRectransform loadFrom = effectToLoadFrom as CurveVelocityZRectransform;
