...
namespace LEM_Editor
{
    ...
    public class CurveVelocityXRectransformNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveVelocityXRectransform";
        ...
        {
            CurveVelocityXRectransform myEffect = ScriptableObject.CreateInstance<CurveVelocityXRectransform>();
        ...
        {
            CurveVelocityXRectransform loadFrom = effectToLoadFrom as CurveVelocityXRectransform;
