...
namespace LEM_Editor
{
    ...
    public class CurveRotationXTransformNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        Space m_RelativeSpace = default;
        protected override string EffectTypeName => "CurveRotationXTransform";
        ...
        {
            CurveRotationXTransform myEffect = ScriptableObject.CreateInstance<CurveRotationXTransform>();
        ...
        {
            CurveRotationXTransform loadFrom = effectToLoadFrom as CurveRotationXTransform;
