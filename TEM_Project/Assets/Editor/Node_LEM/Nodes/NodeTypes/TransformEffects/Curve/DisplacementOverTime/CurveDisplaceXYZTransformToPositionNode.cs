...
namespace LEM_Editor
{
    ...
    public class CurveDisplaceXYZTransformToPositionNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "CurveDisplaceXYZTransformToPosition";
        ...
        {
            CurveDisplaceXYZTransformToPosition myEffect = ScriptableObject.CreateInstance<CurveDisplaceXYZTransformToPosition>();
            ...
            myEffect.SetUp(m_TargetTransform, m_GraphX,m_GraphY,m_GraphZ, m_RelativeToWorld);
            return myEffect;
        ...
        {
            CurveDisplaceXYZTransformToPosition loadFrom = effectToLoadFrom as CurveDisplaceXYZTransformToPosition;
            loadFrom.UnPack(out m_TargetTransform, out m_GraphX,out m_GraphY,out m_GraphZ, out m_RelativeToWorld);
            //Important
