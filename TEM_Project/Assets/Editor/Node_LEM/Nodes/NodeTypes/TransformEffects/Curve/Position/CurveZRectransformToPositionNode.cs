...
namespace LEM_Editor
{
    ...
    public class CurveZRectransformToPositionNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveZRectransformToPosition";
        ...
        public override void Draw()
        {
            ...
            m_XVelocityCurve = EditorGUI.CurveField(propertyRect, "Z Velocity", m_XVelocityCurve);
        ...
        {
            CurveZRectransformToPosition myEffect = ScriptableObject.CreateInstance<CurveZRectransformToPosition>();
        ...
        {
            CurveZRectransformToPosition loadFrom = effectToLoadFrom as CurveZRectransformToPosition;
