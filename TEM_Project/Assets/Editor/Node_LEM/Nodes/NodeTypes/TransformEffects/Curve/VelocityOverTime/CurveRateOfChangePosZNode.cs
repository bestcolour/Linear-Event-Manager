...
namespace LEM_Editor
{
    ...
    public class CurveRateOfChangePosZNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveRateOfChangePosZ";
        ...
        {
            CurveRateOfChangePosZ myEffect = go.AddComponent<CurveRateOfChangePosZ>();
            //CurveRateOfChangePosZ myEffect = ScriptableObject.CreateInstance<CurveRateOfChangePosZ>();
        ...
        {
            CurveRateOfChangePosZ loadFrom = effectToLoadFrom as CurveRateOfChangePosZ;
