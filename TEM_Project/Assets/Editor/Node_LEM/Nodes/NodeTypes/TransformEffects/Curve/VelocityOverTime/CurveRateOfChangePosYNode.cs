...
namespace LEM_Editor
{
    ...
    public class CurveRateOfChangePosYNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveRateOfChangePosY";
        ...
        {
            CurveRateOfChangePosY myEffect = go.AddComponent<CurveRateOfChangePosY>();
            //CurveRateOfChangePosY myEffect = ScriptableObject.CreateInstance<CurveRateOfChangePosY>();
        ...
        {
            CurveRateOfChangePosY loadFrom = effectToLoadFrom as CurveRateOfChangePosY;
