...
namespace LEM_Editor
{
    ...
    public class CurvePosYNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurvePosY";
        ...
        {
            CurvePosY myEffect = go.AddComponent<CurvePosY>();
            //CurvePosY myEffect = ScriptableObject.CreateInstance<CurvePosY>();
        ...
        {
            CurvePosY loadFrom = effectToLoadFrom as CurvePosY;
