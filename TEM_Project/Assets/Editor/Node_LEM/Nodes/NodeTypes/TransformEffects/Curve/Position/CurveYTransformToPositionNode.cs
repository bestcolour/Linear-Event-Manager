...
namespace LEM_Editor
{
    ...
    public class CurveYTransformToPositionNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_VelocityGraph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveYTransformToPosition";
        ...
        public override void Draw()
        {
            ...
            propertyRect.y += 20f;
            m_VelocityGraph = EditorGUI.CurveField(propertyRect, "Y Velocity", m_VelocityGraph);
            propertyRect.y += 20f;
        ...
        {
            CurveYTransformToPosition myEffect = ScriptableObject.CreateInstance<CurveYTransformToPosition>();
        ...
        {
            CurveYTransformToPosition loadFrom = effectToLoadFrom as CurveYTransformToPosition;
