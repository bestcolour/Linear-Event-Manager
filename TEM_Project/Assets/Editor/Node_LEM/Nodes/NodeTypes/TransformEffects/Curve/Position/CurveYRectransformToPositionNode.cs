...
namespace LEM_Editor
{
    ...
    public class CurveYRectransformToPositionNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveYRectransformToPosition";
        ...
        public override void Draw()
        {
            ...
            m_XVelocityCurve = EditorGUI.CurveField(propertyRect, "Y Velocity", m_XVelocityCurve);
        ...
        {
            CurveYRectransformToPosition myEffect = ScriptableObject.CreateInstance<CurveYRectransformToPosition>();
        ...
        {
            CurveYRectransformToPosition loadFrom = effectToLoadFrom as CurveYRectransformToPosition;
