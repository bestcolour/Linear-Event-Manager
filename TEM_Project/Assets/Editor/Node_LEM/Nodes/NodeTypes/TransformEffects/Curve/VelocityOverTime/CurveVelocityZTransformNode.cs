...
namespace LEM_Editor
{
    ...
    public class CurveVelocityZTransformNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveVelocityZTransform";
        ...
        {
            CurveVelocityZTransform myEffect = ScriptableObject.CreateInstance<CurveVelocityZTransform>();
        ...
        {
            CurveVelocityZTransform loadFrom = effectToLoadFrom as CurveVelocityZTransform;
