...
namespace LEM_Editor
{
    ...
    public class CurveRateOfRotationXNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        Space m_RelativeSpace = default;
        protected override string EffectTypeName => "CurveRateOfRotationX";
        ...
        {
            CurveRateOfRotationX myEffect = ScriptableObject.CreateInstance<CurveRateOfRotationX>();
        ...
        {
            CurveRateOfRotationX loadFrom = effectToLoadFrom as CurveRateOfRotationX;
