...
namespace LEM_Editor
{
    ...
    public class CurveVelocityXTransformNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveVelocityXTransform";
        ...
        {
            CurveVelocityXTransform myEffect = ScriptableObject.CreateInstance<CurveVelocityXTransform>();
        ...
        {
            CurveVelocityXTransform loadFrom = effectToLoadFrom as CurveVelocityXTransform;
