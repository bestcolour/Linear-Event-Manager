...
namespace LEM_Editor
{
    ...
    public class CurveRateOfChangeAnchPosXNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveRateOfChangeAnchPosX";
        ...
        {
            CurveRateOfChangeAnchPosX myEffect = go.AddComponent<CurveRateOfChangeAnchPosX>();
            //CurveRateOfChangeAnchPosX myEffect = ScriptableObject.CreateInstance<CurveRateOfChangeAnchPosX>();
        ...
        {
            CurveRateOfChangeAnchPosX loadFrom = effectToLoadFrom as CurveRateOfChangeAnchPosX;
