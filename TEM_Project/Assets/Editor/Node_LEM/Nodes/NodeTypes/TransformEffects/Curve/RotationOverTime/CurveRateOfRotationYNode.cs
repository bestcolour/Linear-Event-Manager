...
namespace LEM_Editor
{
    ...
    public class CurveRateOfRotationYNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        Space m_RelativeSpace = default;
        protected override string EffectTypeName => "CurveRateOfRotationY";
        ...
        {
            LEM_Effects.CurveRateOfRotationY myEffect = ScriptableObject.CreateInstance<LEM_Effects.CurveRateOfRotationY>();
        ...
        {
            LEM_Effects.CurveRateOfRotationY loadFrom = effectToLoadFrom as LEM_Effects.CurveRateOfRotationY;
