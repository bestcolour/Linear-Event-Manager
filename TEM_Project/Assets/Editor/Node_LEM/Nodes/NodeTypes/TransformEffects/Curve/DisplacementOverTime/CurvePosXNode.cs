...
namespace LEM_Editor
{
    ...
    public class CurvePosXNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurvePosX";
        ...
        {
            CurvePosX myEffect = go.AddComponent<CurvePosX>();
            //CurvePosX myEffect = ScriptableObject.CreateInstance<CurvePosX>();
        ...
        {
            CurvePosX loadFrom = effectToLoadFrom as CurvePosX;
