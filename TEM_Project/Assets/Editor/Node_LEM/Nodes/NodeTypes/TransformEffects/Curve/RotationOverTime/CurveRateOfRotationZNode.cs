...
namespace LEM_Editor
{
    ...
    public class CurveRateOfRotationZNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        Space m_RelativeSpace = default;
        protected override string EffectTypeName => "CurveRateOfRotationZ";
        ...
        {
            CurveRateOfRotationZ myEffect = ScriptableObject.CreateInstance<CurveRateOfRotationZ>();
        ...
        {
            CurveRateOfRotationZ loadFrom = effectToLoadFrom as CurveRateOfRotationZ;
