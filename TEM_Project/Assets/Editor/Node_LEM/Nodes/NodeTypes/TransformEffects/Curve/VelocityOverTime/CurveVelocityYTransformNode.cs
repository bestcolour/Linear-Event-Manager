...
namespace LEM_Editor
{
    ...
    public class CurveVelocityYTransformNode : UpdateEffectNode
    {
        Transform m_TargetTransform = default;
        AnimationCurve m_Graph = new AnimationCurve();
        bool m_RelativeToWorld = false;
        protected override string EffectTypeName => "CurveVelocityYTransform";
        ...
        {
            CurveVelocityYTransform myEffect = ScriptableObject.CreateInstance<CurveVelocityYTransform>();
        ...
        {
            CurveVelocityYTransform loadFrom = effectToLoadFrom as CurveVelocityYTransform;
