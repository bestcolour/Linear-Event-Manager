...
namespace LEM_Editor
{
    ...
    public class LerpScaleToTNode : UpdateEffectNode
    {
        [SerializeField]
        ...
        protected override string EffectTypeName => "LerpScaleToT";
        ...
        {
            LerpScaleToT myEffect = go.AddComponent<LerpScaleToT>();
            //LerpScaleToT myEffect = ScriptableObject.CreateInstance<LerpScaleToT>();
        ...
        {
            LerpScaleToT loadFrom = effectToLoadFrom as LerpScaleToT;
