...
namespace LEM_Editor
{
    ...
    public class LerpRotationToTAboutV3PivotNode : UpdateEffectNode
    {
        ...
        public override LEM_BaseEffect CompileToBaseEffect()
        {
            ...
            myEffect.SetUp(m_TargetTransform, m_ReferenceTransformRotation, m_LocalPivotPosition, m_WorldRotation, m_Smoothing, m_SnapRange);
            return myEffect;
        ...
        public override void LoadFromBaseEffect(LEM_BaseEffect effectToLoadFrom)
        {
            ...
            loadFrom.UnPack(out m_TargetTransform, out m_ReferenceTransformRotation, out m_LocalPivotPosition, out m_WorldRotation, out m_Smoothing, out m_SnapRange);
