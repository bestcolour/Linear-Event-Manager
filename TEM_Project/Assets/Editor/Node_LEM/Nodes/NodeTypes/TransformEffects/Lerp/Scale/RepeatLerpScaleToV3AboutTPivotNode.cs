...
namespace LEM_Editor
{
    ...
    public class RepeatLerpScaleToV3AboutTPivotNode : UpdateEffectNode
    {
        [SerializeField]
        ...
        protected override string EffectTypeName => "RepeatLerpScaleToV3AboutTPivot";
        ...
        {
            RepeatLerpScaleToV3AboutTPivot myEffect = go.AddComponent<RepeatLerpScaleToV3AboutTPivot>();
            //RepeatLerpScaleToV3AboutTPivot myEffect = ScriptableObject.CreateInstance<RepeatLerpScaleToV3AboutTPivot>();
        ...
        {
            RepeatLerpScaleToV3AboutTPivot loadFrom = effectToLoadFrom as RepeatLerpScaleToV3AboutTPivot;
