...
namespace LEM_Editor
{
    ...
    public class RepeatLerpScaleRelativeToV3Node : UpdateEffectNode
    {
        [SerializeField]
        ...
        protected override string EffectTypeName => "RepeatLerpScaleRelativeToV3";
        ...
        {
            RepeatLerpScaleRelativeToV3 myEffect = ScriptableObject.CreateInstance<RepeatLerpScaleRelativeToV3>();
        ...
        {
            RepeatLerpScaleRelativeToV3 loadFrom = effectToLoadFrom as RepeatLerpScaleRelativeToV3;
