...
namespace LEM_Editor
{
    ...
    public class LerpScaleToTAboutV3PivotNode : UpdateEffectNode
    {
        [SerializeField]
        ...
        protected override string EffectTypeName => "LerpScaleToTAboutV3Pivot";
        ...
        {
            LerpScaleToTAboutV3Pivot myEffect = go.AddComponent<LerpScaleToTAboutV3Pivot>();
            //LerpScaleToTAboutV3Pivot myEffect = ScriptableObject.CreateInstance<LerpScaleToTAboutV3Pivot>();
        ...
        {
            LerpScaleToTAboutV3Pivot loadFrom = effectToLoadFrom as LerpScaleToTAboutV3Pivot;
