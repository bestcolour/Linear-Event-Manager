...
namespace LEM_Editor
{
    ...
    public class LerpRotationToTNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "LerpRotationToT";
        ...
        {
            LerpRotationToT myEffect = go.AddComponent<LerpRotationToT>();
            //LerpRotationToT myEffect = ScriptableObject.CreateInstance<LerpRotationToT>();
            ...
            myEffect.SetUp(m_TargetTransform, m_ReferenceTransformRotation, m_WorldRotation, m_Smoothing, m_SnapRange);
            return myEffect;
        ...
        {
            LerpRotationToT loadFrom = effectToLoadFrom as LerpRotationToT;
            loadFrom.UnPack(out m_TargetTransform, out m_ReferenceTransformRotation, out m_WorldRotation, out m_Smoothing, out m_SnapRange);
