...
namespace LEM_Editor
{
    ...
    public class MoveTowardsRotationRelativeToV3Node : UpdateEffectNode
    {
        ...
        {
            LEM_Effects.MoveTowardsRotationRelativeToV3 myEffect = ScriptableObject.CreateInstance<LEM_Effects.MoveTowardsRotationRelativeToV3>();
        ...
        {
            LEM_Effects.MoveTowardsRotationRelativeToV3 loadFrom = effectToLoadFrom as LEM_Effects.MoveTowardsRotationRelativeToV3;
