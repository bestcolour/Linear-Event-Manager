...
namespace LEM_Editor
{
    ...
    public class MoveTowardsRotationRelativeToTNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "MoveTowardsRotationRelativeToT";
        ...
        {
           MoveTowardsRotationRelativeToT myEffect = ScriptableObject.CreateInstance<MoveTowardsRotationRelativeToT>();
        ...
        {
            MoveTowardsRotationRelativeToT loadFrom = effectToLoadFrom as MoveTowardsRotationRelativeToT;
