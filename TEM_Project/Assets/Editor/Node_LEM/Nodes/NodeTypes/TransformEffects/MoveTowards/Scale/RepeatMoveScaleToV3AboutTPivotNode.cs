...
namespace LEM_Editor
{
    ...
    public class RepeatMoveScaleToV3AboutTPivotNode : UpdateEffectNode
    {
        [SerializeField]
        ...
        protected override string EffectTypeName => "RepeatMoveScaleToV3AboutTPivot";
        ...
        {
            RepeatMoveScaleToV3AboutTPivot myEffect = go.AddComponent<RepeatMoveScaleToV3AboutTPivot>();
            //RepeatMoveScaleToV3AboutTPivot myEffect = ScriptableObject.CreateInstance<RepeatMoveScaleToV3AboutTPivot>();
        ...
        {
            RepeatMoveScaleToV3AboutTPivot loadFrom = effectToLoadFrom as RepeatMoveScaleToV3AboutTPivot;
