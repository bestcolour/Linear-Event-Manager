...
namespace LEM_Editor
{
    ...
    public class RepeatMoveTowardsRectTransformToPositionNode : UpdateEffectNode
    {
        RectTransform m_TargetRectTransform = default;
        Vector3 m_TargetPosition = default;
        float m_Duration = 0f;

        protected override string EffectTypeName => "RepeatMoveTowRectTransToPos";
        ...
        {
            RepeatMoveTowardsRectransformToPosition myEffect = ScriptableObject.CreateInstance<RepeatMoveTowardsRectransformToPosition>();
        ...
        {
            RepeatMoveTowardsRectransformToPosition loadFrom = effectToLoadFrom as RepeatMoveTowardsRectransformToPosition;
