...
namespace LEM_Editor
{
    ...
    public class InstantiateGameObjectNode : BaseEffectNode
    {
        ...
        public override void Draw()
        {
            ...
            Rect propertyRect = new Rect(m_MidRect.x + NodeGUIConstants.X_DIST_FROM_MIDRECT, m_MidRect.y + NodeGUIConstants.Y_DIST_FROM_MIDRECT, m_MidRect.width - NodeGUIConstants.MIDRECT_WIDTH_OFFSET, 15f);
