...
namespace LEM_Editor
{
    ...
    {
        protected int m_MinArraySize = default;

        protected float m_WidthOfObjectField = default, m_XOffsetOfObjectField = default;

        protected string m_ObjectFieldLabel  = default;
