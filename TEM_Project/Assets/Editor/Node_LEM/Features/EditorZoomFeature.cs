...
namespace LEM_Editor
{
    ...
    public class EditorZoomFeature
    {
        ...
        //public static void BeginZoom(float scale, Rect screenCoordsArea,Vector2 pivotPoint)
        //{
        //    //End group since editor window begins group naturally during onGUI
        //    GUI.EndGroup();

        //    Debug.Log("screenCoordsArea " + screenCoordsArea);

        //    screenCoordsArea.min -= Vector2.one * NodeLEM_Editor.InverseScaleFactor;
        //    //Clipping is basically cropping out things that are not inside the rect
        //    Rect clippedRect = screenCoordsArea.ScaleSizeBy(NodeLEM_Editor.InverseScaleFactor, screenCoordsArea.TopLeft());
