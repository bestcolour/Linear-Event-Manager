...
namespace LEM_Editor
{
    ...
    public class DeleteGroupRectNodeData : BaseDeletionCommandData
    {
        ...
        public static GroupRectNodeBase[] SortGroupRectNodeBasesForSaving(string[] unsortedGroupRectNodeIDs)
        {
            //The order of each group rect node base is important. 
            //
            //              Gen1c1
            ...
            while (true)
            {
                if (NodeLEM_Editor.AllGroupRectsInEditorDictionary[currentNodeID].NestedNodesDictionary.Count > 0)
                {
                    ...
                    for (int i = 0; i < unsortedGroupRectNodeIDs.Length; i++)
                    {
                        ...
                        if (currentNodeID == LEMDictionary.NodeIDs_Initials.k_GroupRectNodeInitial)
                        {
        ...
        public static GroupRectNodeBase[] SortGroupRectNodeBasesForDeletion(string[] unsortedGroupRectNodeIDs)
        {
            //The order of each group rect node base is important. 
            //
            //              Gen1c1
