...
{
    [AddComponentMenu("")] public class  RepeatMoveRotationToTAboutTPivot : TimerBasedUpdateEffect
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            RepeatMoveRotationToTAboutTPivot t = go.AddComponent<RepeatMoveRotationToTAboutTPivot>();
