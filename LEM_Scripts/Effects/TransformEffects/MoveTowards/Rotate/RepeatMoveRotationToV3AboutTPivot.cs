...
{
    [AddComponentMenu("")] public class  RepeatMoveRotationToV3AboutTPivot : TimerBasedUpdateEffect
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            RepeatMoveRotationToV3AboutTPivot t = go.AddComponent<RepeatMoveRotationToV3AboutTPivot>();
