...
{
    [AddComponentMenu("")] public class  CurveRateOfChangeScaleY : SingleCurveBasedUpdateEffect<CurveRateOfChangeScaleY>
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            CurveRateOfChangeScaleY t = go.AddComponent<CurveRateOfChangeScaleY>();
