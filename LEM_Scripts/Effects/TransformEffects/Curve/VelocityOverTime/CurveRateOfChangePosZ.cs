...
{
    [AddComponentMenu("")] public class  CurveRateOfChangePosZ : SingleCurveBasedUpdateEffect<CurveRateOfChangePosZ>
#if UNITY_EDITOR
...
#endif
    {
        ...
        //{
        //    CurveRateOfPosZ copy = ScriptableObject.CreateInstance<CurveRateOfPosZ>();
