...
{
    [AddComponentMenu("")] public class  CurveRateOfChangeRotationX : SingleCurveBasedUpdateEffect<CurveRateOfChangeRotationX>
#if UNITY_EDITOR
...
#endif
    {
        ...
        {
            CurveRateOfChangeRotationX t = go.AddComponent<CurveRateOfChangeRotationX>();
