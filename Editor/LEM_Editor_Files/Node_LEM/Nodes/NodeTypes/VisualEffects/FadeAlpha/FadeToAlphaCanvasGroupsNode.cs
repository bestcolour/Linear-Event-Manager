...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaCanvasGroupsNode : UpdateEffectNode
    {

        ArrayObjectDrawer<CanvasGroup> m_ArrayOfGameObjects = new ArrayObjectDrawer<CanvasGroup>();
        float m_TargetAlpha = 0f, m_Duration = 0f;



        protected override string EffectTypeName => "FadeToAlphaCanvasGroups";
        ...
        {
            FadeToAlphaCanvasGroups myEffect = go.AddComponent<FadeToAlphaCanvasGroups>();
        ...
        {
            FadeToAlphaCanvasGroups loadFrom = effectToLoadFrom as FadeToAlphaCanvasGroups;
            loadFrom.UnPack(out CanvasGroup[] t1, out m_TargetAlpha, out m_Duration);
