...
namespace LEM_Editor
{
    ...
    public class FadeToAlphaTextMeshesNode : UpdateEffectNode
    {

        ArrayObjectDrawer<TextMesh> m_ArrayOfGameObjects = new ArrayObjectDrawer<TextMesh>();
        float m_TargetAlpha = 0f, m_Duration = 0f;


        protected override string EffectTypeName => "FadeToAlphaTextMeshes";
        ...
        {
            FadeToAlphaTextMeshes myEffect = go.AddComponent<FadeToAlphaTextMeshes>();
            //FadeToAlphaTextMeshes myEffect = ScriptableObject.CreateInstance<FadeToAlphaTextMeshes>();
        ...
        {
            FadeToAlphaTextMeshes loadFrom = effectToLoadFrom as FadeToAlphaTextMeshes;
            loadFrom.UnPack(out TextMesh[] t1, out m_TargetAlpha, out m_Duration);
