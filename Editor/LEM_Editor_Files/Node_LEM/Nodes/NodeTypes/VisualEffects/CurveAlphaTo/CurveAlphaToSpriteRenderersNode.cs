...
namespace LEM_Editor
{
    ...
    public class CurveAlphaToSpriteRenderersNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "CurveAlphaToSpriteRenderers";
        ...
        {
            CurveAlphaToSpriteRenderers myEffect = go.AddComponent<CurveAlphaToSpriteRenderers>();
        ...
        {
            CurveAlphaToSpriteRenderers loadFrom = effectToLoadFrom as CurveAlphaToSpriteRenderers;
            loadFrom.UnPack(out SpriteRenderer[] t1, out m_Graph);
