...
namespace LEM_Editor
{
    ...
    public class LerpRotationToV3AboutTPivotNode: UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "LerpRotationToV3AboutTPivot";
        ...
        public override LEM_BaseEffect CompileToBaseEffect(GameObject go)
        {
            ...
            LerpRotationToV3AboutTPivot myEffect = go.AddComponent<LerpRotationToV3AboutTPivot>();
            //LerpRotationToV3AboutTPivot myEffect = ScriptableObject.CreateInstance<LerpRotationToV3AboutTPivot>();
        ...
        {
            LerpRotationToV3AboutTPivot loadFrom = effectToLoadFrom as LerpRotationToV3AboutTPivot;
