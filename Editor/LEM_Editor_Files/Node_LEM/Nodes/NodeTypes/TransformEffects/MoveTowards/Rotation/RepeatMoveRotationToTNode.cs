...
namespace LEM_Editor
{
    ...
    public class RepeatMoveRotationToTNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "RepeatMoveRotationToT";
        ...
        {
            RepeatMoveRotationToT loadFrom = effectToLoadFrom as RepeatMoveRotationToT;
