...
namespace LEM_Editor
{
    ...
    public class MoveRotationToTAboutTPivotNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "MoveRotationToTAboutTPivot";
        ...
        {
            MoveRotationToTAboutTPivot myEffect = go.AddComponent<MoveRotationToTAboutTPivot>();
            //MoveRotationToTAboutTPivot myEffect = ScriptableObject.CreateInstance<MoveRotationToTAboutTPivot>();
        ...
        {
            MoveRotationToTAboutTPivot loadFrom = effectToLoadFrom as MoveRotationToTAboutTPivot;
