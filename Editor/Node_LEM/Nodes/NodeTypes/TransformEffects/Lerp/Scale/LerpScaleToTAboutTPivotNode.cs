...
namespace LEM_Editor
{
    ...
    public class LerpScaleToTAboutTPivotNode : UpdateEffectNode
    {
        [SerializeField]
        ...
        protected override string EffectTypeName => "LerpScaleToTAboutTPivot";
        ...
        {
            LerpScaleToTAboutTPivot myEffect = go.AddComponent<LerpScaleToTAboutTPivot>();
            //LerpScaleToTAboutTPivot myEffect = ScriptableObject.CreateInstance<LerpScaleToTAboutTPivot>();
        ...
        {
            LerpScaleToTAboutTPivot loadFrom = effectToLoadFrom as LerpScaleToTAboutTPivot;
