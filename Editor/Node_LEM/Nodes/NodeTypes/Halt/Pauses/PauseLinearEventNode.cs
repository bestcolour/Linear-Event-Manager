...
namespace LEM_Editor
{
    ...
    public class PauseLinearEventNode : InstantEffectNode
    {
        ...
        public override void Draw()
        {
            ...
            string label = m_TargetLinearEvent == null ? "LinearEvent to Pause" : "Pausing " + m_TargetLinearEvent.m_LinearDescription;
        ...
        public override LEM_BaseEffect CompileToBaseEffect(GameObject go)
        {
            ...
            myEffect.SetUp(m_TargetLinearEvent,m_State, false);
            return myEffect;
        }
        ...
        public override void LoadFromBaseEffect(LEM_BaseEffect effectToLoadFrom)
        {
            ...
            loadFrom.UnPack(out m_TargetLinearEvent,out m_State, out bool unused);
