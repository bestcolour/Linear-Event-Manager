...
namespace LEM_Editor
{
    ...
    public class CurveAlphaToCanvasGroupsNode : UpdateEffectNode
    {
        ...
        protected override string EffectTypeName => "CurveAlphaToCanvasGroups";
        ...
        {
            CurveAlphaToCanvasGroups myEffect = go.AddComponent<CurveAlphaToCanvasGroups>();
        ...
        {
            CurveAlphaToCanvasGroups loadFrom = effectToLoadFrom as CurveAlphaToCanvasGroups;
            loadFrom.UnPack(out CanvasGroup[] t1, out m_Graph);
