...
namespace LEM_Editor
{
    ...
    public class CurveAnchPosZNode : UpdateEffectNode
    {
        protected override string EffectTypeName => "CurveAnchPosZ";
        ...
        public override void Draw()
        {
            ...
            m_Graph = EditorGUI.CurveField(propertyRect, "Z Displacement", m_Graph);
        ...
        {
            CurveAnchPosZ myEffect = go.AddComponent<CurveAnchPosZ>();
            //CurveAnchPosZ myEffect = ScriptableObject.CreateInstance<CurveAnchPosZ>();
        ...
        {
            CurveAnchPosZ loadFrom = effectToLoadFrom as CurveAnchPosZ;
